            ...
            <div class="container">
                <div class="row d-flex flex-row justify-content-">
                    <div class="market_index">
                        <div class="d-flex flex-row">
                            <div onclick="display('section01')">
                                <img src="https://res.cloudinary.com/do6twjc6g/image/upload/v1717491860/arrow-left-short_unsplp.svg"
                                    width="50" class="arrow">
                            </div>
                            <div class="d-flex flex-row">
                                <a>
    ...
    <div id="section1_3">
            ...
            <nav class="navbar navbar-light bg-light fixed-top">
                ...
                <div class="form-inline ">
                        ...
                        <div>
                            <button class="btn btn-outline-success">Collabrate</button>
                        </div>
                        <div>
                            <img src="https://res.cloudinary.com/do6twjc6g/image/upload/v1709136511/person_prwrix.jpg"
                                width="35">
